...
struct SeanceHautDuCorpsView: View {
...
struct SeanceHautDuCorpsView_Previews: PreviewProvider {

    static var previews: some View {
        SeanceHautDuCorpsView(seance: exerciceList2)
